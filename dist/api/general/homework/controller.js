...
exports.deleteHomework = exports.updateHomework = exports.createHomework = exports.fetchHomework = undefined;

var fetchHomework = exports.fetchHomework = function () {
            ...
            while (1) {
                switch (_context.prev = _context.next) {
                    case 0:
                        ...
                        _context.prev = 2;
                        _context.next = 5;
                        return _model2.default.find(filter).populate("course").populate("questionnaires").populate("classrom").populate("students").skip(skip).limit(limit).sort(sort).select(projection).exec();
    ...
    return function fetchHomework(_x, _x2) {
        return _ref.apply(this, arguments);
    };
}();

var createHomework = exports.createHomework = function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(req, res) {
        var data, _Joi$validate, error, newHomework, result;
        ...
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
            while (1) {
                switch (_context2.prev = _context2.next) {
                    case 0:
                        data = req.body;
                        _Joi$validate = _joi2.default.validate(data, _model.homeworkCreate), error = _Joi$validate.error;
                    ...
                    case 4:
                        newHomework = new _model2.default(data);
                        _context2.prev = 5;
                        _context2.next = 8;
                    ...
                    case 12:
                        return _context2.abrupt("return", (0, _lib.success)(res, 201, result, "Homework created successfully!"));
...
var updateHomework = exports.updateHomework = function () {
            ...
            while (1) {
                switch (_context3.prev = _context3.next) {
                    case 0:
                        ...
                        _Joi$validate2 = _joi2.default.validate(data, _model.homeworkUpdate), error = _Joi$validate2.error;
                    ...
                    case 11:
                        return _context3.abrupt("return", (0, _lib.success)(res, 200, result, "Homework updated successfully!"));
...
var deleteHomework = exports.deleteHomework = function () {
        ...
        return regeneratorRuntime.wrap(function _callee4$(_context4) {
            while (1) {
                switch (_context4.prev = _context4.next) {
                    ...
                    case 7:
                        return _context4.abrupt("return", (0, _lib.success)(res, 200, result, "Homework deleted successfully!"));
    ...
    return function deleteHomework(_x7, _x8) {
...
// Logging
var logger = _log4js2.default.getLogger("[homework]");
