...
var createRecord = exports.createRecord = function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(req, res) {
        var data, _Joi$validate, error, email, subject, message, fullname, phone, requestType, newRecord, send, result;
        ...
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
            while (1) {
                switch (_context2.prev = _context2.next) {
                    ...
                    case 4:
                        email = data.email, subject = data.subject, message = data.message, fullname = data.fullname, phone = data.phone, requestType = data.request_type;
                        newRecord = new _model2.default(data);
                        _context2.prev = 6;
                        send = (0, _services.emailFromContactus)(email, subject, message, fullname, phone, requestType);
...
// Logging
var logger = _log4js2.default.getLogger("[contact_us]");
