            ...
            while (1) {
                switch (_context.prev = _context.next) {
                    case 0:
                        ...
                        _context.prev = 2;
                        _context.next = 5;
                        return _model2.default.find(filter).populate("assigned_to", "id surname other_name email phone").populate("assigned_by", "id surname other_name email phone").populate("voucher").populate("asset_assignment").populate("office_id").skip(skip).limit(limit).sort(sort).select(projection).exec();
