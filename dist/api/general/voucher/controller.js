...
exports.deleteRecord = exports.auditRecord = exports.updateRecord = exports.createRecord = exports.fetchRecord = undefined;
            ...
            while (1) {
                switch (_context4.prev = _context4.next) {
                    case 0:
                        ...
                        _Joi$validate3 = _joi2.default.validate(data, _model.schemaAudit), error = _Joi$validate3.error;
...
var deleteRecord = exports.deleteRecord = function () {
    ...
    return function deleteRecord(_x9, _x10) {
...
// Logging
var logger = _log4js2.default.getLogger("[voucher]");
