            ...
            while (1) {
                switch (_context.prev = _context.next) {
                    case 0:
                        ...
                        _context.prev = 2;
                        _context.next = 5;
                        return _model2.default.find(filter).populate("course").populate("course_id").populate("examiner").populate("question").populate("venue").populate("staff_id").populate("student_id").skip(skip).limit(limit).sort(sort).select(projection).exec();
