            ...
            while (1) {
                switch (_context.prev = _context.next) {
                    case 0:
                        ...
                        _context.next = 7;
                        return _model2.default.find(filter).populate("students").populate("state").populate("county").populate("staff").skip(skip).limit(limit).sort(sort).select(projection).exec();
