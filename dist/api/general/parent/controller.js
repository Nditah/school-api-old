            ...
            while (1) {
                switch (_context.prev = _context.next) {
                    case 0:
                        ...
                        _context.next = 7;
                        return _model2.default.find(filter).populate("students_name").populate("state").populate("county").populate("staff").skip(skip).limit(limit).sort(sort).select(projection).exec();
        ...
        return regeneratorRuntime.wrap(function _callee5$(_context5) {
            while (1) {
                switch (_context5.prev = _context5.next) {
                    ...
                    case 3:
                        return _context5.abrupt("return", (0, _services.parentAuthenticate)(req.body).then(function (_ref6) {
...
// Logging
var logger = _log4js2.default.getLogger("[parent]");
