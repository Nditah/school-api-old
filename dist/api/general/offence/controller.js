...
exports.deleteOffenceType = exports.updateOffenceType = exports.createOffenceType = exports.fetchOffenceType = exports.deleteOffence = exports.updateOffence = exports.createOffence = exports.fetchOffence = undefined;

var fetchOffence = exports.fetchOffence = function () {
            ...
            while (1) {
                switch (_context.prev = _context.next) {
                    case 0:
                        ...
                        _context.prev = 2;
                        _context.next = 5;
                        return _model.Offence.find(filter).populate("staff_id", "id surname given_name email phone").populate("partner_id", "id surname given_name email phone").populate("verdict_by", "id surname given_name email phone").skip(skip).limit(limit).sort(sort).select(projection).exec();
    ...
    return function fetchOffence(_x, _x2) {
        return _ref.apply(this, arguments);
    };
}();

var createOffence = exports.createOffence = function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(req, res) {
        var data, _Joi$validate, error, newOffence, result;
        ...
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
            while (1) {
                switch (_context2.prev = _context2.next) {
                    case 0:
                        data = req.body;
                        _Joi$validate = _joi2.default.validate(data, _model.offenceCreate), error = _Joi$validate.error;
                    ...
                    case 4:
                        newOffence = new _model.Offence(data);
                        _context2.prev = 5;
                        _context2.next = 8;
                        return newOffence.save();
                    ...
                    case 12:
                        return _context2.abrupt("return", (0, _lib.success)(res, 201, result, "Offence created successfully!"));
    ...
    return function createOffence(_x3, _x4) {
        return _ref2.apply(this, arguments);
    };
}();

var updateOffence = exports.updateOffence = function () {
            ...
            while (1) {
                switch (_context3.prev = _context3.next) {
                    case 0:
                        ...
                        _Joi$validate2 = _joi2.default.validate(data, _model.offenceUpdate), error = _Joi$validate2.error;
                    ...
                    case 5:
                        _context3.prev = 5;
                        _context3.next = 8;
                        return _model.Offence.findOneAndUpdate({ _id: id }, data, { new: true });
                    ...
                    case 11:
                        return _context3.abrupt("return", (0, _lib.success)(res, 200, result, "Offence updated successfully!"));
    ...
    return function updateOffence(_x5, _x6) {
        return _ref3.apply(this, arguments);
    };
}();

var deleteOffence = exports.deleteOffence = function () {
            ...
            while (1) {
                switch (_context4.prev = _context4.next) {
                    case 0:
                        ...
                        _context4.prev = 1;
                        _context4.next = 4;
                        return _model.Offence.findOneAndRemove({ _id: id });
                    ...
                    case 7:
                        return _context4.abrupt("return", (0, _lib.success)(res, 200, result, "Offence deleted successfully!"));
    ...
    return function deleteOffence(_x7, _x8) {
...
var fetchOffenceType = exports.fetchOffenceType = function () {
            ...
            while (1) {
                switch (_context5.prev = _context5.next) {
                    case 0:
                        ...
                        _context5.prev = 2;
                        _context5.next = 5;
                        return _model.OffenceType.find(filter).skip(skip).limit(limit).sort(sort).select(projection).exec();
    ...
    return function fetchOffenceType(_x9, _x10) {
        return _ref5.apply(this, arguments);
    };
}();

var createOffenceType = exports.createOffenceType = function () {
    var _ref6 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6(req, res) {
        var data, _Joi$validate3, error, newOffenceType, result;
        ...
        return regeneratorRuntime.wrap(function _callee6$(_context6) {
            while (1) {
                switch (_context6.prev = _context6.next) {
                    case 0:
                        data = req.body;
                        _Joi$validate3 = _joi2.default.validate(data, _model.offenceTypeCreate), error = _Joi$validate3.error;
                    ...
                    case 4:
                        newOffenceType = new _model.OffenceType(data);
                        _context6.prev = 5;
                        _context6.next = 8;
                        return newOffenceType.save();
                    ...
                    case 12:
                        return _context6.abrupt("return", (0, _lib.success)(res, 201, result, "OffenceType created successfully!"));
    ...
    return function createOffenceType(_x11, _x12) {
        return _ref6.apply(this, arguments);
    };
}();

var updateOffenceType = exports.updateOffenceType = function () {
            ...
            while (1) {
                switch (_context7.prev = _context7.next) {
                    case 0:
                        data = req.body;
                        id = req.params.recordId;
                        _Joi$validate4 = _joi2.default.validate(data, _model.offenceTypeUpdate), error = _Joi$validate4.error;
                    ...
                    case 5:
                        _context7.prev = 5;
                        _context7.next = 8;
                        return _model.OffenceType.findOneAndUpdate({ _id: id }, data, { new: true });
                    ...
                    case 11:
                        return _context7.abrupt("return", (0, _lib.success)(res, 200, result, "OffenceType updated successfully!"));
    ...
    return function updateOffenceType(_x13, _x14) {
        return _ref7.apply(this, arguments);
    };
}();

var deleteOffenceType = exports.deleteOffenceType = function () {
            ...
            while (1) {
                switch (_context8.prev = _context8.next) {
                    case 0:
                        ...
                        _context8.prev = 1;
                        _context8.next = 4;
                        return _model.OffenceType.findOneAndRemove({ _id: id });
                    ...
                    case 7:
                        return _context8.abrupt("return", (0, _lib.success)(res, 200, result, "OffenceType deleted successfully!"));
    ...
    return function deleteOffenceType(_x15, _x16) {
...
// Logging
var logger = _log4js2.default.getLogger("[offence]");
