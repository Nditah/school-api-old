            ...
            while (1) {
                switch (_context.prev = _context.next) {
                    case 0:
                        ...
                        _context.next = 7;
                        return _model2.default.find(filter).populate("teacher").populate("classe").populate("subject").populate("staff").skip(skip).limit(limit).sort(sort).select(projection).exec();
...
// Logging
var logger = _log4js2.default.getLogger("[course]");
