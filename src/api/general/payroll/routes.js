...
import {
    ...
    fetchPayrollDetail, createPayrollDetail, updatePayrollDetail, deletePayrollDetail,
} from "./controller";
 ...
 */
router.get("/payrolls", [checkAuth, isValidStaff], fetchPayroll);
 ...
 */
router.post("/payrolls", [checkAuth, isValidStaff], createPayroll);
 ...
 * @apiError 401 master access only.
 */
router.put("/payrolls/:recordId", [checkAuth, isValidStaff], updatePayroll);
 ...
 * @apiError 401 master access only.
 */
router.delete("/payrolls/:recordId", [checkAuth, isValidStaff], deletePayroll);
 ...
 * @apiError {Object} 400 Some parameters may contain invalid values.
 */
router.get("/payroll-details", [checkAuth, isValidStaff], fetchPayrollDetail);
 ...
 * @apiError 401 master access only.
 */
router.post("/payroll-details", [checkAuth, isValidStaff], createPayrollDetail);
 ...
 * @apiError 401 master access only.
 */
router.put("/payroll-details/:recordId", [checkAuth, isValidStaff], updatePayrollDetail);
 ...
 * @apiError 401 master access only.
 */
router.delete("/payroll-details/:recordId", [checkAuth, isValidStaff], deletePayrollDetail);
